...
class UserSession {
    ...
    login = async body => {
        try {
            let request = await fetch(`https://django-acm.herokuapp.com/users/login/`, {
                method: 'POST',
                headers: {
    ...
    signup = async body => {
        try {
            let request = await fetch(`https://django-acm.herokuapp.com/users/signup/`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
    ...
    editProfile = async (id, token, body) => {
        ...
        try {
            let request = await fetch(`https://django-acm.herokuapp.com/profile/${id}/`, {
                method: 'PATCH',
                headers: {
                    Accept: 'application/json',
