...
const imageBackground = {
    uri: 'https://images3.alphacoders.com/686/thumb-1920-686773.jpg',
};
    ...
    handleSubmit = async () => {
        try {
            ...
            if (typeof response == 'object') {
                ...
                if (response['405']) {
                    var message = 'This account is not verified';
                } else {
                    var message = 'Username or Password not valid. please try again.';
                }
